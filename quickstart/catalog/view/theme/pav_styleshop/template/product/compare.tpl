...
<div class="container">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <section id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <div class="table-responsive wrapper">
        <table class="table table-bordered">
          ...
          <tr>
            <td></td>
            <?php foreach ($products as $product) { ?>
            <td><input type="button" value="<?php echo $button_cart; ?>" class="button btn btn-theme-default" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" />
              <a href="<?php echo $product['remove']; ?>" class="button btn btn-theme-default"><?php echo $button_remove; ?></a></td>
            <?php } ?>
          </tr>
        </table>
      ...
      <?php } else { ?>
      <div class="content">
        <div class="wrapper"><?php echo $text_empty; ?>
          <div class="buttons">
            <div class="right"><a href="<?php echo $continue; ?>" class="button btn btn-theme-default"><?php echo $button_continue; ?></a></div>
          </div>
        </div>
