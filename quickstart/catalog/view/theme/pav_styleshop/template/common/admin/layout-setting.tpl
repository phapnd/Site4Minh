...
<div class="clearfix">
	<table class="form">
		<tr>
			<td>
			<b><?php echo $objlang->get('text_show_module_onlayout'); ?></b>
			</td>
			<td>
			<select name="elayout_id"  id="elayout_id" >
...
<div class="theme-layout clearfix">
		...
		<div class="slideshow  edit-container clearfix" data-position="mainmenu">
			<div class="explain"><?php echo $objlang->get('text_explain_mainmenu');?></div>
			...
			?>
				<div class="module-pos <?php if( !$modulepos['status']){ ?>mod-disable<?php } ?>" data-position="mainmenu" data-id="<?php echo $modulepos['code']."-".$modulepos['index'];?>">
						<div class="edit-module">
							<a target="_blank" href="<?php echo $ourl->link('module/'.$modulepos['code'],'token='.$token);?>"><b><?php echo $modulepos['title']; ?></b></a><i>[[index:<?php echo $modulepos['index'];?>]</i>
						</div>
					</div>
			<?php } }?>
		</div>
...
$(".edit-module a").click( function(){
	...
	$('#dialogeditmodule').dialog({
		title: '<?php echo $objlang->get("text_module_setting"); ?>',
