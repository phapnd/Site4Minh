...
<div class="product-info">
    ...
    <div class="col-lg-<?php echo $cols[1]; ?> col-md-<?php echo $cols[1]; ?> col-sm-12 col-xs-12 product-view">
        ...
        <div id="product" class="product-extra">
            ...
            <div class="action">
                <a class="product-icon fa fa-heart product-icon" onclick="wishlist.addwishlist('<?php echo $product_id; ?>');">
                </a> 
                <a class="product-icon fa fa-refresh" onclick="compare.addcompare('<?php echo $product_id; ?>');">                            
                </a>
            </div>
