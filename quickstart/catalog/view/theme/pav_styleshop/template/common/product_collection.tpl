<?php  
	...
	$MAX_ITEM_ROW_SMALL = $listingConfig['listing_products_columns_small']?$listingConfig['listing_products_columns_small']:4;
...
<div id="products" class="product-<?php echo $DISPLAY_MODE; ?>"> 
	<div class="products-block">
		...
		?>
		<div class="col-lg-<?php echo $span;?> col-md-<?php echo $span;?> col-sm-6 col-xs-<?php echo $mini;?> product-cols">			
