...
<?php endif; ?></div>
 ...
 <?php // Jquery googlemap api v3?>
    ...
    <script type="text/javascript">
        ...
        var lat = <?php echo isset($themeConfig['location_latitude'])?$themeConfig['location_latitude']:'22.39978974625941'; ?>;
        var lon = <?php echo isset($themeConfig['location_longitude'])?$themeConfig['location_longitude']:'103.44501546609396'; ?>;
            ...
            mapDiv.height(400).gmap3({
                ...
                marker:{
                    values:[
                        ...
                        {latLng:[lat, lon], data:"<?php echo isset($themeConfig['location_address'])?$themeConfig['location_address']:'Đường Trần Hưng Đạo - Tổ 5 - Phường Quyết Tiến - Tp Lai Châu- Tỉnh Lai Châu'; ?>"},
                    ],
                    options:{
                        draggable: false
                    },
